...
Route::get('/mahasiswa', function () {
    $list_mahasiswa = ["Jonatan Hutahaean","Veronica Valentina","Jenifer Octavia","Ceci Katarina","Abidin Panjaitan","Mario Sostenes","Joseph Excelson","Robin Hood","Asep Udin","Fernando Hutabarat"];
